    ...
    <div className="min-h-screen bg-background flex flex-col pb-8">
      ...
      <main className="flex-1 max-w-md mx-auto w-full px-4 py-8">
          ...
          <div className="bg-primary text-on-primary px-6 py-4">
            <div className="flex items-center justify-between">
              <div>
                ...
                <p className="text-headline-sm">{trip?.company?.name || '—'}</p>
              </div>
        ...
        <div className="space-y-3">
          <a
            href={`${import.meta.env.VITE_API_URL || 'http://localhost:3000'}/api/tickets/${id}/download`}
            target="_blank"
            rel="noopener noreferrer"
            className="w-full bg-primary text-on-primary py-4 rounded-xl text-label-lg font-semibold flex items-center justify-center gap-2 hover:bg-primary-container transition-colors"
          >
